...
export default function SpecularButton({
  ...
  // Refs must not be written during render — keep this in an effect instead.
  useEffect(() => {
    propsRef.current = {
      radius,
      lineColor,
  ...
  useEffect(() => {
    ...
    // tests) — fail silently, the button stays fully usable without the shine.
